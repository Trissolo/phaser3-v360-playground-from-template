...
import SceneSecond from './Scenes/SceneSecond.mjs';

import SceneA from './Scenes/SceneA.mjs';

import SceneB from './Scenes/SceneB.mjs';
...
const config = {
    ...
    //scene: [SceneVariablesTest, SceneSecond]
    scene: [SceneVariablesTest, SceneA, SceneB]
};
